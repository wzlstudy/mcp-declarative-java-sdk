...
public class TestMcpPrompts {
  ...
  public static String prompt1(
      @McpPromptParam(name = "argument1", description = "argument1", required = true)
          String argument1,
      @McpPromptParam(name = "argument2", description = "argument2", required = true)
          String argument2) {
    return String.format(
        "This is prompt1, required argument1: %s, required argument2: %s", argument1, argument2);
  }
  ...
  public static String prompt2(
    ...
    return String.format(
        "This is prompt2, optional argument1: %s, optional argument2: %s", argument1, argument2);
  }
}
