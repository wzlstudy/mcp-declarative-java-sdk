...
public class TestMcpTools {
  ...
  public static String tool1(
      @McpToolParam(name = "argument1", description = "argument1", required = true)
          String argument1,
      @McpToolParam(name = "argument2", description = "argument2", required = true)
          String argument2) {
    return String.format(
        "This is tool1, required argument1: %s, required argument2: %s", argument1, argument2);
  }
  ...
  public static String tool2(
    ...
    return String.format(
        "This is tool2, optional argument1: %s, optional argument2: %s", argument1, argument2);
  }
  ...
  public static String tool3(
    ...
    return String.format(
        "This is tool3 for testing complex json schema: my name is %s, I am from %s",
